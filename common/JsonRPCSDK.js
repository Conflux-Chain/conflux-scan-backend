...
class JsonRPCSDK {
    constructor(config = {}) {
        ...
        this.proxyToProvider = lodash.mapValues(proxy, (each) => providerFactory(lodash.isString(each) ? { url: each, ...OPTIONS, ...options } : each));
