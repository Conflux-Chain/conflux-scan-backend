...
export class TokenSecurityAudit2 extends Model<ITokenSecurityAudit> implements ITokenSecurityAudit{
    id?:number
    // basic info
    hex40id:number
    base32:string
    ...
    static register(seq:Sequelize) {
        TokenSecurityAudit2.init({
            ...
            tableName: 'token_security_audit2',
            sequelize: seq,
            timestamps: true,
        })
    }
