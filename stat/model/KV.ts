...
export const KEY_PRUNE_EPOCH_ADDR_AA_TX = 'KEY_PRUNE_EPOCH_ADDR_AA_TX'
export const KEY_PRUNE_SWITCH_ADDR_AA_TX = 'KEY_PRUNE_SWITCH_ADDR_AA_TX'
...
export const KEY_AUTO_DETECT_TOKEN_TRACE_ID = 'KEY_AUTO_DETECT_TOKEN_TRACE_ID'
export const KEY_AUTO_DETECT_TOKEN_EPOCH = 'KEY_AUTO_DETECT_TOKEN_EPOCH'
...
export const KEY_STAT_TASK_ABI_SAVE_PREFIX = "STAT_TASK_ABI_SAVE:"
export const KEY_SOLC_VERSIONS = "SOLC_VERSIONS"
export const KEY_SOLC_VULNERABILITIES = "SOLC_VULNERABILITIES"
export const KEY_VYPER_VERSIONS = "VYPER_VERSIONS"
export const KEY_FE_VERSIONS = "FE_VERSIONS"
export const KEY_VERIFIED_MATCH_ID = "VERIFIED_MATCH_ID"
