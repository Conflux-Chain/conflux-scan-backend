...
import {checkTokenNameLength, Token} from "../model/Token";
...
export class EpochSync extends SyncBase {
    ...
    async saveOnce(modelData, voteParamArray) {
        ...
        modelData.tokenArray?.forEach(checkTokenNameLength);
        modelData.announcedTokenArray?.forEach(checkTokenNameLength);
