...
export const GAS_PRICE_TRACKER_Q = 'GAS_PRICE_TRACKER_Q';
export const GAS_USED_PER_SECOND_Q = 'GAS_USED_PER_SECOND_Q';
...
export const STREAM_STAT_NFT_MINT_Q = 'STREAM_STAT_NFT_MINT_Q';
...
export class RedisWrap{
    ...
    static async readStreamMessage(q:string, preIdExclusive = 0) {
        ...
        return redisWrap.sendCommand('XREAD', ['BLOCK', 10, 'COUNT', 300, 'STREAMS', q, preIdExclusive])
    }
