...
export const CONST = {
  ...
  CONTRACT_LICENSE: {
    ...
    4: {code: 'GNU GPLv2', desc: 'GNU General Public License v2.0'},
    5: {code: 'GNU GPLv3', desc: 'GNU General Public License v3.0'},
    6: {code: 'GNU LGPLv2.1', desc: 'GNU Lesser General Public License v2.1'},
    7: {code: 'GNU LGPLv3', desc: 'GNU Lesser General Public License v3.0'},
    8: {code: 'BSD-2-Clause', desc: 'BSD 2-clause "Simplified" license'},
    9: {code: 'BSD-3-Clause', desc: 'BSD 3-clause "New" Or "Revised" license*'},
    10: {code: 'MPL-2.0', desc: 'Mozilla Public License 2.0'},
    11: {code: 'OSL-3.0', desc: 'Open Software License 3.0'},
    12: {code: 'Apache-2.0', desc: 'Apache 2.0'},
    13: {code: 'GNU AGPLv3', desc: 'GNU Affero General Public License'},
    14: {code: 'BSL 1.1', desc: 'Business Source License'},
  },
